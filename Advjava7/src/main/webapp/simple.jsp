...
<jsp:setProperty property="empno" name="emp" value="1002"/>
<jsp:setProperty property="name" name="emp" value="Akash"/>
<jsp:setProperty property="salary" name="emp" value="50000"/>
